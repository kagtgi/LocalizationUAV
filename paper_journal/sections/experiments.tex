...
pipeline. (iii) \emph{Oracle structure}: the query structure replaced by the
satellite segmentation under the true footprint, isolating
image$\rightarrow$structure errors from matcher errors. (iv) \emph{Local
...
\label{sec:why_m0}
\TBD{Condensed from the conference analysis: coverage 93\%, retrieval@20 = 0\%,
kilometre-level median error across five sites; impostor density.}
